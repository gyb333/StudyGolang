...
import (
	...
	"projects/crawler_distributed/zhenai/parser"

	"projects/crawler_distributed/persist"
	"projects/crawler_distributed/scheduler"
	itemsaver "projects/crawler_distributed/persist/client"
	worker "projects/crawler_distributed/worker/client"
)
